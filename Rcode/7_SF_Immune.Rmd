...
Classical_kmeans=data.frame(Cluster=sce_combine2$Kmeans,Subtype=sce_combine2$labels)%>%mutate(Subtype=gsub("Monocyte","Macrophage",Subtype))%>%mutate(Subtype=ifelse(Subtype=="Macrophage"&Cluster%in%c(4,5),"M1_macro", ifelse(Subtype=="Macrophage","M2_macro",Subtype )))
